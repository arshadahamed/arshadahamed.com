                ...
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline">
                    ...
                    <p className="inner-headline__text t-large t-bright loading__item">
                      👋 Hey! I’m Arshad Ahamed, Obviously I'm a Full Stack Developer and Graphic Designer.
                      Highly driven Computer Science graduate with a solid foundation in software engineering and programming principles.Skilled in delivering innovative solutions through full stack development . Passionate about continuous learning and staying updated with industry trends to drive impactful results in diverse technical environments
                    </p>
                  </div>
                </div>
              </div>
