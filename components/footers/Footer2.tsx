...
export default function Footer2({ text = "Arshad Ahamed" }: { text?: string }) {
  return (
        ...
        <div className="mxd-footer__fullwidth-text anim-top-to-bottom">
          {text == "Arshad Ahamed" ? (
            <svg
              ...
              xmlSpace="preserve"
            >
              <path d="M26.64,1.36L0,60.74h14.85l4.41-10.69h29.27l4.41,10.69h15.01L41.48,1.36h-14.84ZM24.26,38.09l9.76-23.41,9.59,23.41h-19.34Z" />
              <path d="M124.82,33.08c2.35-3.22,3.52-7.1,3.52-11.62,0-3.96-.88-7.46-2.63-10.52-1.75-3.05-4.24-5.41-7.46-7.08-3.22-1.67-6.99-2.5-11.28-2.5h-28.93v59.38h13.91v-19.59h8.06l15.1,19.59h16.54l-16.8-20.78c4.3-1.36,7.62-3.65,9.97-6.87ZM112.23,27.78c-1.58,1.44-3.87,2.16-6.87,2.16h-13.49V13.23h13.49c2.94,0,5.22.74,6.83,2.21,1.61,1.47,2.42,3.53,2.42,6.19s-.79,4.71-2.38,6.15Z" />
              <path d="M184.75,30.58c-3.96-3.08-9.95-5.08-17.98-5.98-4.19-.51-7.17-1.27-8.95-2.29-1.78-1.02-2.67-2.46-2.67-4.33s1.03-3.45,3.1-4.58c2.06-1.13,4.82-1.7,8.27-1.7,5.6,0,10.72,1.61,15.35,4.84l6.53-9.76c-3-2.15-6.46-3.82-10.39-5-3.93-1.19-7.96-1.78-12.09-1.78-4.81,0-9.05.76-12.72,2.29-3.68,1.53-6.53,3.68-8.57,6.45-2.04,2.77-3.05,5.97-3.05,9.59,0,5.37,1.88,9.5,5.64,12.39,3.76,2.88,9.68,4.78,17.77,5.68,4.18.45,7.24,1.22,9.16,2.29,1.92,1.08,2.88,2.57,2.88,4.5,0,2.04-1.03,3.65-3.1,4.84-2.07,1.19-4.85,1.78-8.36,1.78-7.01,0-13.15-2.06-18.41-6.19l-7.21,10.09c3.28,2.66,7.17,4.72,11.66,6.19,4.5,1.47,9.17,2.21,14.04,2.21s9.27-.78,13.06-2.33c3.79-1.55,6.73-3.76,8.82-6.62,2.09-2.86,3.14-6.15,3.14-9.88,0-5.37-1.98-9.6-5.94-12.68Z" />
              <polygon points="242.94 24.35 217.75 24.35 217.75 1.36 203.84 1.36 203.84 60.74 217.75 60.74 217.75 36.9 242.94 36.9 242.94 60.74 256.77 60.74 256.77 1.36 242.94 1.36 242.94 24.35" />
              <path d="M293.59,1.36l-26.64,59.38h14.84l4.41-10.69h29.27l4.41,10.69h15.01L308.43,1.36h-14.84ZM291.21,38.09l9.76-23.41,9.59,23.41h-19.34Z" />
              <path d="M396.1,15.4c-2.52-4.5-6.08-7.96-10.69-10.39-4.61-2.43-9.97-3.65-16.07-3.65h-24.35v59.38h24.35c6.11,0,11.46-1.22,16.07-3.65,4.61-2.43,8.17-5.9,10.69-10.39,2.52-4.5,3.77-9.71,3.77-15.65s-1.26-11.15-3.77-15.65ZM381.38,43.86c-3.05,3.17-7.07,4.75-12.05,4.75h-10.43V13.49h10.43c3.28,0,6.18.72,8.69,2.16,2.52,1.44,4.47,3.48,5.85,6.11,1.39,2.63,2.08,5.73,2.08,9.29,0,5.37-1.53,9.64-4.58,12.81Z" />
            </svg>
          ) : (
            <svg
              className="mxd-footer__svg-v2"
        ...
        <div className="footer-blocks__column animate-card-3">
          ...
          <div className="footer-blocks__card">
            ...
            c0,0,1.3-0.1,1.8-0.2c1,0,4,0,4,0c0.2,0,0.4-0.2,0.4-0.4C20,9.8,19.8,9.6,19.6,9.6L19.6,9.6z"
              ...
              <a href="tel:+94711890590">+94 711890590</a>
            </p>
          </div>
          {/* inner card */}
